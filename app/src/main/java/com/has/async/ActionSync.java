...
public class ActionSync extends AsyncTask<String, Void, Long> {
    ...
    protected Long doInBackground(String... strings) {
        ...
        try {
            Response<Long> response = apiService.createAction(strings[0], strings[1], strings[2], Long.valueOf(strings[3]),
