...
public class SensorSync extends AsyncTask<String, Void, Long> {
    ...
    protected Long doInBackground(String... strings) {
        ...
        try {
            Response<Long> response = apiService.createSensor(strings[0], strings[1], strings[2], Long.valueOf(strings[3]),
